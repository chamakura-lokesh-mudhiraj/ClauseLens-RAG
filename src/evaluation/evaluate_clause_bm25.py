...
from src.retrieval import clause_bm25_retriever
...
def main():
    ...
    print("=" * 60)
    print("CLAUSE-AWARE BM25 EVALUATION")
    print("=" * 60)
    ...
    retriever = clause_bm25_retriever.ClauseBM25Retriever()
    ...
    print("\n" + "=" * 60)
    print("CLAUSE-AWARE BM25 RESULTS")
    print("=" * 60)
